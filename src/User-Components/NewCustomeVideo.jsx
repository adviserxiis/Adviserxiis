...
const NewCustomVideo = ({ data }) => {
  ...
  return (
    <div className="relative  h-screen w-screen   font-Poppins">
      ...
      <div className="absolute bottom-24 sm:bottom-28 right-4 text-white text-2xl md:text-3xl  cursor-pointer z-30" onClick={handleMuteClick}>
      ...
      <div className="absolute bottom-36 sm:bottom-40 right-4 flex flex-col  items-center space-y-2  z-30">
        <div className=" flex flex-col items-center cursor-pointer">
          ...
          {liked ? <div className="cursor-pointer text-2xl md:text-3xl lg:text-4xl ">
