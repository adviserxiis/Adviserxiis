...
const NewCreatePostDialog = ({ open, handleClose }) => {
  ...
  return (
    <Dialog open={open} onClose={handleClose} fullWidth maxWidth="sm" PaperProps={{
      style: {
        ...
        <div className="bg-[#121212] text-white   flex flex-col items-center font-Poppins">
            {/* Header */}
            ...
            {/* Bottom Section */}
            <div className="p-4 w-full flex  flex-col justify-between gap-4 max-w-md  ">
                {/* File Input */}
                <input
                    name="hashtags"
...
export default NewCreatePostDialog;
