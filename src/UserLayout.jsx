...
import NewUserSideBar from "./User-Components/NewUserSideBar";
import NewUserFooter from "./User-Components/NewUserFooter";
...
function UserLayout() {
  ...
  return (
    ...
    <div className="flex flex-row overflow-hidden ">
      ...
      >
        <NewUserSideBar showSideBar={showSideBar} handleOpen={handleDialogOpen} setShowSideBar={setShowSideBar}/>
      </Transition>
      </div>
      ...
      <div className="flex-1">
        ...
        <div
          className={`pt-0 lg:pt-[0px]  transition-all duration-[400ms] ${
