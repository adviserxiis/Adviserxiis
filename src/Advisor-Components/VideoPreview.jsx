        ...
        <div className='min-h-screen sm:pt-[50px] mb-[120px] font-Poppins'>
            <div className='mx-4'>
                ...
                <div className='flex flex-col  justify-center  items-center'>
                    <div className='w-[300px] h-[400px] sm:w-[500px] sm:h-[600px] md:w-[600px] md:h-[700px]  bg-gray-200'>
                        {postFileURL && (
              ...
              formik.errors.post_file && (
                ...
                <form onSubmit={formik.handleSubmit} className='mt-4'>
                    <div>
                        <label className="block text-sm  text-gray-500 font-Poppins">Write caption...</label>
                        <textarea
                            ...
                            className="w-full mt-1 p-2  border-b border-black focus:outline-none focus:border-b focus:border-gray-500 rounded-none font-Poppins h-12"
                            rows="3"
                        />
                    ...
                    <button type='button' className='w-1/2 mt-4 text-gray-500 border border-gray-500 px-4 py-2 rounded-md mx-2'>Cancel</button>
